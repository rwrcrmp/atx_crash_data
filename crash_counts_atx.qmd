...
Reducing complexity in spatial data does make co-location simpler, but it comes with trade offs. One upside is that it makes exploratory data analysis (EDA) much easier. With non-spatial data, EDA usually involves traditional charts like histograms and bar charts:
